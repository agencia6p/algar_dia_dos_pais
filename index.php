...
<head>
    ...
    <title>Algar - Dia dos Pais</title>
...
<body>
    ...
    <div class="container" style="margin-bottom: 200px">
        <div class="row" style="margin-bottom: 50px">
            <div class="col-md-offset-3 col-md-9" style="height: 15px; background: url(media/img/header.png)">
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-5">
                <div class="row">
                    <div class="col-md-6 text-center">
                        ...
                        <p class="white h3" style="margin-top: -20px;">
                            Apresenta:
                        </p>
                    </div>
                    <div class="col-md-6">
                        <img src="media/img/logo_campanha_algar_dia_dos_pais.png" class="img-responsive hidden-xs hidden-sm">
                        <img src="media/img/logo_campanha_algar_dia_dos_pais.png" class="img-responsive visible-xs visible-sm center-block" style="margin-top: 95px;">
                    </div>
                </div>
                <div class="row" style="margin-top: 100px;">
                    <div class="col-md-12">
                        <div style="background: rgba(0, 166, 81, 0.8); border-radius: 5px; padding: 5px 20px">
                            <h3 class="white bold text-uppercase">
                                Conte pra gente, qual é o <span class="yellow">megasonho</span> do seu pai?<br/>A algar telecom vai realizar!
                            </h3>
                            <p class="white">
                                Envie um <b>vídeo</b>, um <b>audio</b> (mp3) ou <b>escreva</b> para nós contando qual é o grande sonho do seu pai.
                            </p>
                            <p class="white">
                                <span class="yellow bold">Aí é só cruzar os dedos!</span><br /><b>O resto, deixa com a gente.</b>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4" style=" margin-top: 70px;">
                <div style="background: rgba(255, 255, 255, 1); padding: 25px; border-radius: 8px;">

                    <p class="h3 bold" style="color: rgb(0, 105, 166); margin-bottom: 30px;">
                        Preencha todos os campos do formulário abaixo com os seus dados completos.
                    </p>

                    <form method="post" action="send.php" id="formulario" enctype="multipart/form-data" class="form">
                        <div class="form-group">
                            <input class="form-control" type="text" id="nome" name="nome" placeholder="Nome:">
                        </div>
    
                        <div class="form-group">
                            <input class="form-control" type="text" name="email" id="email" placeholder="E-mail:" onblur="validacaoEmail(this)">
                        </div>
    
                        <div class="form-group">
                            <input class="form-control" type="text" name="cpf" id="cpf" onkeypress="mascaraMutuario(this,cpfCnpj)" onblur="clearTimeout()" placeholder="CPF:" maxlength="14">
                        </div>
                        
                        <div class="form-group">
                            <textarea name="mensagem" id="mensagem" placeholder="Conte aqui o megasonho do seu pai:" rows="5" class="form-control"></textarea>
                            <p id="limite" class="small text-muted" style="margin-top: 0" >Você pode escrever <span>500</span> caracteres</p>
                        </div>
    
                        <div class="form-group">
                            <input type="checkbox" name="regulamento" id="regulamento"><label class="text-muted small" for="regulamento" id="labelReg">Li e aceito os termos do <a data-fancybox data-src="#hidden-content" href="javascript:;">regulamento</a>.</label>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" class="hidden" id="arquivo" name="arquivo" placeholder="Anexar">
                            <img src="media/img/audio_icon.png" alt="Ícone de áudio" class="pull-left">
                            <img src="media/img/video_icon.png" alt="Ícone de vídeo" class="pull-left">
                            <img src="media/img/text_icon.png" alt="Ícone de texto" class="pull-left">
                        </div>
    
                        <div style="margin-top: 70px">
                            <button type="submit" class="btn btn-block btn-algar">Enviar</button>
                        </div>
                    </form>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-offset-3 col-md-9" style="height: 150px; background: url(media/img/footer.png)">
                    <div class="row">
                        <div class="col-xs-12">
                            <div style="padding: 50px">
                                <a href="#">
                                    <img src="media/img/fb_icon.png" class="pull-left" style="margin-left: 20px">
                                </a>
                                <a href="#">
                                    <img src="media/img/youtube_icon.png" class="pull-left" style="margin-left: 20px">
                                </a>
                                <a href="#">
                                    <img src="media/img/instagram_icon.png" class="pull-left" style="margin-left: 20px">
                                </a>
                            </div>
                        </div>
                    </div>
