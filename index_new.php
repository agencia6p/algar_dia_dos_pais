...
<ul class="bg">
    <div class="cycle-slideshow" data-cycle-fx="fade" data-cycle-pause-on-hover="true" data-cycle-speed="1000">
        <img src="media/img/bg.jpg">
        <img src="media/img/bg-2.jpg">
        <img src="media/img/bg-3.jpg">
    </div>
</ul>
<main class="main">
    <section id="content" class="container">
        <header class="col-md-5 col-md-offset-2">
            <img src="media/img/logo-algar.png" class="pull-left" id="logoAlgar">
            <p>Apresenta</p>

            <img src="media/img/logo-algar-maes.png" id="logoMaes" class="img-responsive center-block">
        </header>
        ...
        <div class="col-md-5 col-md-offset-2 info">
            ...
            <p>Nós vamos transformar este sonho em realidade.
            Mas não apenas um. Serão três sonhos, de três mães.</p>

            <p>Pra participar, é bem simples. </p>

            <p>Você pode nos contar por <strong>vídeo, <br>
            áudio</strong> ou <strong>escrever</strong> aqui a sua história. <br>
            Daí, é só começar a torcer. </p>
